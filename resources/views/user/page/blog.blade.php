                        ...
                        <div class="blog_left_sidebar">
                            <article class="blog_item">
                                <div class="blog_item_img">
                                    <img class="card-img rounded-0" src="{{asset('assets/img/blog/single_blog_1.png')}}"
                                        alt="">
                                ...
                                <div class="blog_details">
                                    <a class="d-inline-block" href="{{route('user.blog_details')}}">
                            ...
                            <article class="blog_item">
                                <div class="blog_item_img">
                                    <img class="card-img rounded-0" src="{{asset('assets/img/blog/single_blog_2.png')}}"
                                        alt="">
                                    <a href="#" class="blog_item_date">
                                        <h3>15</h3>
                                        <p>Jan</p>
                            ...
                            <article class="blog_item">
                                <div class="blog_item_img">
                                    <img class="card-img rounded-0" src="{{asset('assets/img/blog/single_blog_3.png')}}"
                                        alt="">
                                    <a href="#" class="blog_item_date">
                                        <h3>15</h3>
                                        <p>Jan</p>
                            ...
                            <article class="blog_item">
                                <div class="blog_item_img">
                                    <img class="card-img rounded-0" src="{{asset('assets/img/blog/single_blog_4.png')}}"
                                        alt="">
                                    <a href="#" class="blog_item_date">
                                        <h3>15</h3>
                                        <p>Jan</p>
                            ...
                            <article class="blog_item">
                                <div class="blog_item_img">
                                    <img class="card-img rounded-0" src="{{asset('assets/img/blog/single_blog_5.png ')}}"
                                        alt="">
                                    <a href="#" class="blog_item_date">
                                        <h3>15</h3>
                                        <p>Jan</p>
                            ...
                            <aside class="single_sidebar_widget popular_post_widget">
                                ...
                                <div class="media post_item">
                                    ...
                                    <div class="media-body">
                                        <a href="{{route('user.blog_details')}}">
