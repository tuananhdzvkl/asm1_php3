  ...
  <div class="container">
    <div class="card o-hidden border-0 shadow-lg my-5">
      <div class="card-body p-0">
        ...
        <div class="row">
          <div class="col-lg-5 d-none d-lg-block bg-register-image"><img src="{{asset('admin_assets/img/undraw_creative_team_r90h.svg')}}" alt="" width="100%" style="height: 350px; margin-top: 4pc; margin-left: 2pc;"></div>
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Create an Account!</h1>
              </div>
              <form action="{{ route('register.save') }}" method="POST" enctype="multipart/form-data" class="user">
                @csrf
                ...
                <div class="form-group">
                    <input name="image" type="file" class="form-control form-control-user @error('image')is-invalid @enderror">
                    @error('image')
                        <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
